...
if __name__ == "__main__":
    ...
    acc = np.array([[0.62,0.64,0.68,0.67,0.68,0.67,0.68,0.65],
                [0.65,0.65,0.70,0.67,0.71,0.67,0.66,0.66],
                [0.58,0.64,0.64,0.66,0.66,0.67,0.64,0.64],
                [0.60,0.66,0.65,0.66,0.65,0.65,0.62,0.62],
                [0.61,0.64,0.65,0.65,0.64,0.65,0.64,0.66],
                [0.62,0.64,0.66,0.66,0.64,0.66,0.62,0.65],
                [0.64,0.64,0.64,0.68,0.66,0.66,0.62,0.64],
                [0.65,0.66,0.66,0.64,0.65,0.64,0.62,0.62],
                [0.67,0.62,0.66,0.67,0.62,0.68,0.64,0.61],
                [0.67,0.64,0.67,0.64,0.63,0.64,0.63,0.62]])
    y=[2,3,5,7,9,11,13,15,21,33]
    x=[8,16,32,64,128,256,512,1024]
    create_heatmap(acc, y, x, "1DCNN_heatmap", title="Accuracy for the 1D-CNN")
